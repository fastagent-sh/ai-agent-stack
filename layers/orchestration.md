...
| [restatedev/restate](https://github.com/restatedev/restate)<br><sub>Restate is the platform for building resilient applications that tolerate all infrastructu</sub> | **59** | 29 | 99 | 50 | 4,410 | — | — | 2d ago | 18+ |
| [agentscope-ai/AgentTeams](https://github.com/agentscope-ai/AgentTeams)<br><sub>An open-source Collaborative Multi-Agent OS for transparent, human-in-the-loop task coordi</sub> | **58** | 30 | 68 | 76 | 5,615 | — | — | 23d ago | 17 |
| [conductor-oss/conductor](https://github.com/conductor-oss/conductor)<br><sub>Conductor is an event driven agentic workflow engine providing durable and highly resilien</sub> | **57** | 36 | 95 | 40 | 32,200 | — | — | 2d ago | 15 |
| [23blocks-OS/ai-maestro](https://github.com/23blocks-OS/ai-maestro)<br><sub>AI Agent Orchestrator with Skills System - Give AI Agents superpowers: memory search, code</sub> | **57** | 23 | 98 | 48 | 781 | — | — | 3d ago | 3 |
| [desplega-ai/agent-swarm](https://github.com/desplega-ai/agent-swarm)<br><sub>Your Company Agentic Operating System</sub> | **55** | 23 | 100 | 42 | 771 | — | — | 1d ago | 6+ |
| [compozy/compozy](https://github.com/compozy/compozy)<br><sub>An operating system for AI agents. Plug in the agent CLIs you already use (Claude Code, Co</sub> | **52** | 28 | 98 | 29 | 2,748 | — | — | 3d ago | 28+ |
| [dataelement/bisheng](https://github.com/dataelement/bisheng)<br><sub>BISHENG is an open LLM devops platform for next generation Enterprise AI applications. Pow</sub> | **44** | 33 | 75 | 24 | 11,958 | — | — | 10d ago | 3+ |
| [temporalio/temporal](https://github.com/temporalio/temporal)<br><sub>Temporal service</sub> | **43** | 35 | 75 | 19 | 23,004 | — | — | 2d ago | 4+ |
| [aannoo/claude-hook-comms](https://github.com/aannoo/claude-hook-comms)<br><sub>Let AI agents message, watch, and spawn each other across terminals. Claude Code, Codex, A</sub> | **39** | 22 | 58 | 36 | 490 | — | — | 35d ago | 14 |
| [aannoo/hcom](https://github.com/aannoo/hcom)<br><sub>Let AI agents message, watch, and spawn each other across terminals. Claude Code, Codex, A</sub> | **39** | 22 | 58 | 36 | 490 | — | — | 35d ago | 14 |
